...
class PostListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        posts = Post.objects.filter(author__in=follows).order_by('-date_posted').all()
        for z in posts:
            filename=z.document
            # pdb.set_trace()
            if filename.name:
        ...
        data['temp'] = drop
        print("usssssssssseeeeeeeeer",all_users, file=sys.stderr)
        print("33333333333333333333:::::::::::",data)
        return data
